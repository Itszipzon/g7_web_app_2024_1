...
public class MainTest {
  public static void main(String[] args) {
    ...
    String vla =
        "\"{\"IsAvailable\":true,\"LocationAddress\":\"Millergata 46, 6789 Bill\",\"LocationName\":\"Miller Bil\"}\"";
  ...
  public static void findNonWhitespaceCharacter(String jsonString) {
    ...
    for (char c : jsonString.toCharArray()) {
      ...
      if (!Character.isWhitespace(c) && position < 100) {
        System.out.println("Unexpected non-whitespace character found at position: " + position
            + ", character: " + c);
      }
    }
  }
